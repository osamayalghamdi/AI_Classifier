...
An **incident classification + grouping system** for pilgrim service call centers (Nusuk/Umrah/Hajj). Bilingual Arabic/English. Feed it a support ticket, get back a structured classification, similar open incidents, and a grouped view of what's actually happening.
